########################  SQL STRINGS ####################################
main_sql_str = "select b.url, a.title, a.dateAdded, a.BOOKMARK_ID from WM_BOOKMARK a, WM_PLACE b where a.PLACE_ID = b.PLACE_ID and a.USER_ID = ? and  ("
hist_sql_str = "select b.url, a.title, a.dateAdded, a.BOOKMARK_ID  from WM_BOOKMARK a, WM_PLACE b where a.PLACE_ID = b.PLACE_ID and a.USER_ID = ?  ";
date_sql_str = "select b.url, a.title, a.dateAdded, a.BOOKMARK_ID  from WM_BOOKMARK a, WM_PLACE b where a.PLACE_ID = b.PLACE_ID and a.USER_ID = ?  order by a.dateAdded desc limit 100"
